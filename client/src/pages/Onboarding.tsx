...
import { ArrowLeft, ArrowRight, PersonStanding, User, ScaleIcon, Target } from "lucide-react"
      ...
      <div className="onboarding-container">
        ...
        <div className="p-6 pt-12 onboarding-wrapper">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-4">
            Let's personalize your experience with UJJWAL
          </p>
          ...
          {step == 1 && (
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 mb-8">
                <div className="size-12 rounded-xl bg-emerald-500 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center"><User className="size-6 text-emerald-600 dark:text-emerald-400" /></div>
                <div>
          ...
          {step == 2 && (
            <div className="space-y-6 onboarding-wrapper">
              ...
              <div className="flex flex-col gap-4 max-w-2xl">
                ...
                <Input label="Height (cm) - Optional" type="number" value={formData.height} onChange={(v) => updateField('height', v)} placeholder="Enter Your height" min={100} max={250} required />
              </div>
            ...
            <div className="space-y-6 onboarding-wrapper">
              ...
              <div className="space-y-8 max-w-lg">
                ...
                <div className="space-y-6">
                  ...
                  <Slider label="Daily Calorie Intake" min={120} max={4000} step={50} value={formData.dailyCalorieIntake} onChange={(v) => updateField('dailyCalorieIntake', v)} unit="kcal" infoText="The total calores you plan to consume each day." />

                  <Slider label="Daily Calorie Burn" min={100} max={2000} step={50} value={formData.dailyCalorieBurn} onChange={(v) => updateField('dailyCalorieBurn', v)} unit="kcal" infoText="The total calores you aim to burn through exercise and activity each day." />
                </div>
              </div>
            </div>
          )}
